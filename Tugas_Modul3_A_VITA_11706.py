...
st.markdown("<h1 style='text-align: center; color: #4CAF50;'>Prediksi IPK - 11706 </h1>", unsafe_allow_html=True)
...
if uploaded_file is not None:
    ...
    model_directory = r'D:\Kuliah\SEM 5\ml\Pertemuan 5\Supervised Learning (Praktek)\Model Suprevised Learning (Praktek)\Tugas3_A_11706'
